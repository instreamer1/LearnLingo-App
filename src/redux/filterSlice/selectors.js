...
export const selectAllLanguages = createSelector(
  [selectAllTeachers],
  (teachers) => [...new Set(teachers.flatMap((teacher) => teacher.languages))]
);

export const selectAllLevels = createSelector(
  [selectAllTeachers],
  (teachers) => [...new Set(teachers.flatMap((teacher) => teacher.levels))]
);

export const selectAllPrices = createSelector(
    [selectAllTeachers],
    (teachers) => [...new Set(teachers.flatMap((teacher) => teacher.price_per_hour))]
  );
